...
class AlertTicket(BaseModel):
    ...
    def to_dict(self):
        return {
            ...
            'investigation_notes': [note.to_dict() for note in self.investigation_notes], # type: ignore    
            'reports': [report.to_dict() for report in self.reports], # type: ignore    
            'alertlogs': [log.to_dict() for log in self.alertlogs], # type: ignore    
            'customfields': [field.to_dict() for field in self.customfields] # type: ignore    
        }

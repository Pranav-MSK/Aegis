...
metrics = {
    ...
    'DB_REQUESTS': Summary('db_requests_by_endpoint', 'Total database requests made', ['route']),
    ...
    'ERROR_METRIC_COUNTER': Counter('error_metric_counter', 'Total error metrics recorded'),
}
